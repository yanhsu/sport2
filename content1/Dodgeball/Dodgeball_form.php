...
<body>
	...
	<form id="commentForm" action="Dodgeball_post.php" method="POST">
		<div class="rowElem">
         <table  border="0">
          <?php for($i=0 ; $i<=19 ; $i++){?>  
          <?php if($i>=10){?>
          <tr>
		   ...
		   <tr>
            ...
            <input <?php if($i<=9) echo "class='required'" ?> type="text" name="select[<?=$i?>]" size="15"/></td>
            </td>
            <td width="65" align="center" nowrap="nowrap">	姓名：</td>
            <td width="105" align="center" nowrap="nowrap">
            <input <?php if($i<=9) echo "class='required'" ?> type="text" name="name[<?=$i?>]" size="15"/></td>
            <td width="65" align="center" nowrap="nowrap">學號：</td>
            <td width="105" align="center" nowrap="nowrap">
            <input <?php if($i<=9) echo "class='required'" ?> type="text" name="num[<?=$i?>]" size="15"/></td>
          </tr>
          <?php }else{ ?>
          <tr>
            <td width="65" align="center" nowrap="nowrap">年級：</td>
