...
$team=$_POST["team"];
$sql="SELECT min(id) FROM Dodgeball where team='$team=';";
...
<table  border="0">
  <tr>
    <td colspan="6" align="center" nowrap="nowrap"><? echo "你的隊伍編號為：".$team; ?></td>
  </tr>
  <?php for($i=0 ; $i<=19; $i++){
  ...
  $name=$_POST["name"][$i];
  $num=$_POST["num"][$i];
  $sql="update Dodgeball set name='$name', number='$num', grade='$grade' where team = '$team' and id ='$id[0]'";
    $id[0]++;
  //echo $sql;
