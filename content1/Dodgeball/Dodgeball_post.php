...
<table  border="0">
  <tr>
    <td colspan="6" align="center" nowrap="nowrap"><? echo "你的隊伍編號為：".$team[0]; ?></td>
  </tr>
  <?php for($i=0 ; $i<=19 ; $i++){
  ...
  $num=$_POST["num"][$i];
  $pass=$_POST["password"];
  $sql="insert into Dodgeball (id, name, number, grade,team,pass) values ('', '$name', '$num','$grade','$team[0]','$pass')";
 // echo $sql;
