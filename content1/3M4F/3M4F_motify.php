...
echo $team;
$str="select pass from 3m4f where team ='$team' order by id;"; 
...
echo "密碼正確";
$str="select name,number,grade,team_name from 3m4f where team ='$team' order by id;"; 
...
?>	
	...
	<form id="commentForm" action="3M4F_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
