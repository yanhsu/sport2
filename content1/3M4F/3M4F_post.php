...
<head>
<meta http-equiv="refresh" content="4;URL=../../0.html"../../0.html";url="0.html">
...
<table  border="0">
  ...
  $sql="insert into 3m4f (id, name, number, grade,team,pass,team_name) values ('', '$name', '$num','$grade','$team[0]','$pass','$team_name')";
 // echo $sql;
