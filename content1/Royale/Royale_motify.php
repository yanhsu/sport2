...
echo $team;
$str="select pass from royale where team ='$team' order by id;"; 
...
echo "密碼正確";
$str="select name,number,grade,team_name from royale where team ='$team' order by id;"; 
...
?>	
	...
	<form id="commentForm" action="Royale_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
        <input type="hidden" name="team" size="15" value="<?=$team?>" />
        
          <?php for($i=0 ; $i<=5 ; $i++){  list($name,$num,$grade,$team_name)=mysql_fetch_row($result)?>
          <tr>
