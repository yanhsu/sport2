...
<table border="0">
  <tr>
    <td colspan="2" align="center">羽球單打賽</td>
  </tr>
  <tr>
    <td width="120">&nbsp;</td>
    <td >&nbsp;</td>
...
?>
<a href="B_one_form.php" target="_blank"><button>我要報名</button></a>
...
$sql="SELECT max(team) FROM B_one";
...
{ 
   ...
   $str="select name,number,grade from B_one where team ='$i' order by id;"; 
...
<table width="416" border="0">
  <tr>
    ...
    <td colspan="2" align="center"><form action="B_one_motify_check.php" method="post" > <input type="hidden" name="team" value="<?=$i?>" /><input type="submit" value="我想修改" /></form></td>
  </tr>
