...
$str="select pass from B_two where team ='$team' order by id;"; 
...
echo "密碼正確";
$str="select name,number,grade from B_two where team ='$team' order by id;"; 
...
?>	
	...
	<form id="commentForm" action="B_two_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
