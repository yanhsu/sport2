...
<body>
	...
	<form id="commentForm" action="Billiards_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
          <?php for($i=0 ; $i<=1 ; $i++){?>  
          <tr>
            ...
            <input class="required" type="text" name="name[<?=$i?>]" size="15"/></td>
            <td width="65" align="center" nowrap="nowrap">學號：</td>
            <td width="105" align="center" nowrap="nowrap">
            <input class="required" type="text" name="num[<?=$i?>]" size="15"/></td>
          </tr>
...
　　
<input name="Submit" type="button" id="Submit" onClick="javascript:history.back(1)" value="回一上頁" /></td>
          </tr>
        </table>
       　
　　　　　　　
