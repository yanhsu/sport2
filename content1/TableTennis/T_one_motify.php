...
$str="select pass from T_one where team ='$team' order by id;"; 
...
echo "密碼正確";
$str="select name,number,grade from T_one where team ='$team' order by id;"; 
...
?>	
	...
	<form id="commentForm" action="T_one_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
