...
<table border="0">
  <tr>
    <td colspan="2" align="center">桌球單人賽</td>
  </tr>
  <tr>
    <td width="120">&nbsp;</td>
    <td >&nbsp;</td>
  ...
  <tr>
    ...
    <td><li>若報名隊伍超過四隊，採單淘制；若少於四隊則採循環制，<span class="red">取冠亞軍</span>。 </li>
		<li><span class="red">賽制採男單&女單分開賽制，男單&女單各取冠亞軍</span>。</li> </td>
	</td>
  </tr>
  <tr>
...
?>
<a href="T_one_form.php" target="_blank"><button>我要報名</button></a>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>［目前報名清單］</p>
<?php
...
$sql="SELECT max(team) FROM T_one";
...
{ 
   ...
   $str="select name,number,grade from T_one where team ='$i' order by id;"; 
...
<table width="416" border="0">
  <tr>
    ...
    <td colspan="2" align="center"><form action="T_one_motify_check.php" method="post" > <input type="hidden" name="team" value="<?=$i?>" /><input type="submit" value="我想修改" /></form></td>
  </tr>
