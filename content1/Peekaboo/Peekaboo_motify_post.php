...
$team=$_POST["team"];
$sql="SELECT min(id) FROM peekaboo where team='$team=';";
...
<table  border="0">
  ...
  $name=$_POST["name"][$i];
  $num=$_POST["num"][$i];
  $sql="update peekaboo set name='$name', number='$num', grade='$grade',team_name='$team_name' where team = '$team' and id ='$id[0]'";
    $id[0]++;
  //echo $sql;
