...
<head>
<meta http-equiv="refresh" content="2;URL=../../index.php"../../0.html";url="index.php">
...
$team=$_POST["team"];
$sql="SELECT min(id) FROM Bowling where team='$team=';";
...
<table  border="0">
  <tr>
    <td colspan="6" align="center" nowrap="nowrap"><?php echo "你的隊伍編號為：".$team; ?></td>
      ...
      <tr>
    <td colspan="6" align="center" nowrap="nowrap"><?php echo "你的隊伍名稱為為：".$team_name; ?></td>
  </tr>
  <?php for($i=0 ; $i<=4; $i++){
  ...
  $name=$_POST["name"][$i];
  $num=$_POST["num"][$i];
  $sql="update Bowling set name='$name', number='$num', grade='$grade',team_name='$team_name' where team = '$team' and id ='$id[0]'";
    $id[0]++;
  //echo $sql;
