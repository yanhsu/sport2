...
$str="select pass from three_point where team ='$team' order by id;";
...
echo "密碼正確";
$str="select name,number,grade from three_point where team ='$team' order by id;";
...
?>	
	...
	<form id="commentForm" action="3Point_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
