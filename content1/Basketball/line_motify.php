...
$str="select pass from line where team ='$team' order by id;"; 
...
echo "密碼正確";
$str="select name,number,grade from line where team ='$team' order by id;"; 
...
?>	
	...
	<form id="commentForm" action="line_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
