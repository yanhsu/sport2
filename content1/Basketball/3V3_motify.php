...
$str="select pass from 3V3 where team ='$team' order by id;";
...
echo "密碼正確";
$str="select name,number,grade,team_name from 3V3 where team ='$team' order by id;";
...
?>	
	...
	<form id="commentForm" action="3V3_motify_post.php" method="POST">
		<div class="rowElem">
        <table  border="0">
