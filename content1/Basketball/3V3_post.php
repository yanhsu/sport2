...
<head>
<meta http-equiv="refresh" content="4;URL=../../index.php"../../0.html";url="index.php">
...
<table  border="0">
  ...
  $sql="insert into 3V3 (id, name, number, grade,team,pass,team_name) values ('', '$name', '$num','$grade','$team[0]','$pass','$team_name')";
 // echo $sql;
